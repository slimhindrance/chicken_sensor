...
# Set up GPIO pin 26 as a button input (with internal pull-down resistor)
button = Button(26, pull_up=False)  # pull_up=False means it's using the internal pull-down resistor
...
def log_state_change(state):
    ...
    with open("gpio26_log.txt", "a") as log_file:
